  ...
  const models = [
    {
      ...
      storage: "256GB, 512GB, 1TB ou 2TB",
    ...
    },
    {
      ...
      storage: "128GB, 256GB, 512GB ou 1TB",
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400">
            Quatro acabamentos em alumínio lindos
          </p>
        </div>
        ...
        <div className="text-center mt-16">
          <button className="bg-blue-700 hover:bg-blue-800 text-white px-12 py-4 rounded-full text-lg font-medium transition-all duration-300 mb-2 hover:scale-105 shadow-md shadow-blue-500/50">
            Compre agora a partir de R$10.299,90
          </button>
          <p className="text-gray-400 mt-2">
            Ou em até 12x de R$859,32 sem juros
          </p>
        </div>
      </div>
    </section>
